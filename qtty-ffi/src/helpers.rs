...
mod tests {
    ...
    fn test_all_helper_functions_cover_unit_variants() {
        ...
        assert_eq!(kilometers_qty.unit, UnitId::Kilometer as u32);
        ...
        assert_eq!(hours_qty.unit, UnitId::Hour as u32);
        ...
        assert_eq!(days_qty.unit, UnitId::Day as u32);
